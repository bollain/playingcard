...
//  PlayingCard
//
//  Created by Armando Dorantes Bollain y Goytia on 2018-02-28.
...
class PlayingCardView: UIView {
    ...
    lazy var upperLeftCornerLabel: UILabel = createCornerLabel()
    lazy var lowerRightCornerLabel: UILabel = createCornerLabel()
...
extension PlayingCardView {
    //Eliminate magic numbers by keeping them all in the same location
...
//Helpful extensions to make code cleaner
extension CGRect {
    var leftHalf: CGRect {
